#########################################################
# output.tf
# Correct HCL output blocks; normalized s3_key fallback to .msi
#########################################################
...
# Normalized s3_key output: prefer actual created object's key; otherwise compute a .msi fallback.
output "s3_key" {
